...
class StorePanelDamageRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'loading_video' => 'required_without:loading_video_path|file|mimes:mp4,avi,mov,wmv|max:10240',
            'loading_video_path' => 'required_without:loading_video|string|nullable',
            'pallet_images' => 'required|array|min:4|max:4',
