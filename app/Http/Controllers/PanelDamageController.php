...
use App\Http\Requests\StorePanelDamageRequest;
use App\Services\ServiceRequestService;
use App\Traits\ApiResponse;
use Illuminate\Http\Request;

class PanelDamageController extends Controller
{
    use ApiResponse;
    ...
    {
        return view('service.form', ['type' => 'panel_damage']);
    }

    public function store(StorePanelDamageRequest $request)
    {
